  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans selection:bg-kora selection:text-white pt-20 pb-20 px-6">
      ...
      <section className="max-w-4xl mx-auto text-center mb-24 mt-12">
        <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-kora/30 bg-purple-50 text-kora text-xs font-pixel tracking-widest uppercase">
          The Founder's Story
        </div>
        <h1 className="text-4xl md:text-6xl font-pixel mb-8 tracking-tight leading-tight uppercase">
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-10 hover:border-kora transition-colors group shadow-sm hover:shadow-[0_10px_30px_-10px_rgba(107,0,255,0.3)]">
          ...
          <h3 className="text-2xl font-pixel text-slate-900 mb-4 uppercase tracking-wider">Premium Grade</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-10 hover:border-fuchsia-500 transition-colors group shadow-sm hover:shadow-[0_10px_30px_-10px_rgba(217,70,239,0.3)]">
          ...
          <h3 className="text-2xl font-pixel text-slate-900 mb-4 uppercase tracking-wider">Direct Connection</h3>
          <p className="text-slate-600 leading-relaxed text-sm font-sans">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-10 hover:border-pink-500 transition-colors group shadow-sm hover:shadow-[0_10px_30px_-10px_rgba(236,72,153,0.3)]">
          ...
          <h3 className="text-2xl font-pixel text-slate-900 mb-4 uppercase tracking-wider">UAE Exclusive</h3>
          <p className="text-slate-600 leading-relaxed text-sm font-sans">
      ...
      <section className="max-w-4xl mx-auto text-center border-t border-slate-200 pt-16">
        <h2 className="text-3xl font-pixel uppercase tracking-widest mb-6">Support the local hustle.</h2>
        <Link href="/shop" className="inline-block bg-slate-900 text-white hover:bg-kora px-10 py-4 rounded-full font-pixel text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-md hover:shadow-[0_0_20px_rgba(107,0,255,0.4)]">
          Enter The Vault
        </Link>
      </section>
