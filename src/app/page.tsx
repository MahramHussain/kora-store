      ...
      <section className="w-full bg-white dark:bg-slate-950 border-b border-neutral-100 dark:border-slate-800 py-12 md:py-16 px-4 md:px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <Link href="/shop?q=Argentina" className="group flex flex-col items-center text-center">
            <div className="w-full aspect-square overflow-hidden flex items-center justify-center p-0 mb-4 bg-[#ffffff] dark:bg-[#020617] hover:shadow-md transition-shadow duration-300 border border-transparent dark:border-slate-800 rounded-2xl">
              <img 
